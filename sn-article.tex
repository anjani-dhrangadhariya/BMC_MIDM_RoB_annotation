...
Recently Dhrangadhariya \textit{et al.} worked on a pilot study to test whether the currently available RoB 2.0 guidelines could be applied to manually annotate an RoB corpus using a multi-level annotation scheme adapted from the same guidelines.
...
\subsection*{Funding}
%
Will be added after successful review
%
%
%
