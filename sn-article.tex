...
Additionally, the response judgement is incorporated in the label, such as ``1.1 Yes Good'' for a well-executed randomization.
...
However, in some cases, "probably yes" and "probably no" may still be used.
...
\begin{figure}
    \centering
    \includegraphics[width=0.90\columnwidth]{figures/rob1_flowchart.png}
