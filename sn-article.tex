...
In contrast, for the top five signal questions shown in Figure~\ref{fig:ann_counts}, both annotators consistently rated the availability of information as ``high", ``very high" (except once as ``normal"). 
However, take this qualitative feedback with a grain of salt because the annotator feedback depends on the number and kind of RCTs they annotated.
The annotator who annotated more documents tended to rate the availability of information on the lower ends while the annotator who annotated less documents was lenient.
%
%
%
\subsection{Inter-Annotator Agreement}
