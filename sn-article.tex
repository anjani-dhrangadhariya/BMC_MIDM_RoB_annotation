...
A portion of the corpus (25 out of 60) was used to evaluate ChatGPT using a straightforward evaluation framework.
% 
...
\begin{center}
 ...
 \centering
    ...
    \midrule
        Poor & 0-0.99 & None & 0-0.20 \\ 
        Slight & 1 - 20.99 & Minimal & 0.21-0.39 \\ 
        Fair & 21 - 40.99 & Weak & 0.40-0.59 \\ 
        Good & 41 - 60.99 & Moderate & 0.60-0.79 \\ 
        Substantial & 61 - 80.99 & Strong & 0.80-0.90 \\ 
        Almost perfect & 81 - 99.99 & Almost Perfect & above 0.90 \\ 
        Perfect & 100 &  &  \\ 
    \bottomrule
    \end{tabular}
 \end{table}   
...
We report Cohens Kappa $\kappa$ in the Table~\ref{tab:IAA_response}~\cite{mchugh2012interrater}.

Overall Cohen's kappa agreement between the rater  51.87\%.
...
\begin{table}[]
    ...
    \begin{tabular}{crr}
        \hline
        Signalling question & Cohens kappa agreement & Contribution from No Information \\
        \hline
        1.1 & 74.28 & 22.22 \\
        1.2 & 35.71 & 33.33 \\
        1.3 & 0 & 11.11 \\
...
% Risk Domain one
For the first risk domain SQ 1.3, we saw a comparatively lower agreement between ChatGPT and the experts because the answer to this SQ is typically found in the table text of RCT.
...
Maybe this was the reason why ChatPDF sought to answer this question typically using RCT text rather than the table text.
