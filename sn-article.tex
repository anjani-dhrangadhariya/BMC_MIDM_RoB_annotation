...
It is also cognitively demanding given one needs to do back and forth over entire RCT full-text carefully and annotate 22 bias classes.
This task could definitely not be managed by non-expert annotators.
To support the bias assessment, RoB 2.0 tool provides extensive bias assessment guidelines.
These guidelines are the step-by-step instructions using the signalling questions as explained in the subsection~\ref{met:annot_scheme}.
Through their pilot annotation study, Dhrangadhariya \textit{et al.} demonstrated that RoB 2.0 guidelines cannot be used RoB annotation guidelines directly given the subjectivity of these guidelines.
Several papers explored subjectivity of the Cochrane RoB 1.0 and 2.0 tools~\cite{minozzi2022reliability,da2017effect,loef2022interrater}.
...
For us, ensuring consistency and reliability among annotators is important.
Therefore, we developed clear and crisp annotation guidelines along with our team of expert annotators which are formatted in form of visual placards.
The visual annotation placards were created based on the revised RoB 2.0 tool and were developed collaboratively by our team of four experts.
Each placard is a flowchart and instructs the annotators to annotate for a single signalling question.
...
With a substantial background in both physiotherapy, advanced statistical methods and experience writing systematic reviews, both experts possesses a deep understanding of the complexities involved in assessing risk of bias in research studies.
...
Additionally, two researchers with expertise in natural language processing (NLP) were involved, one being a linguistics professor and the other a PhD student in computer science.
...
Followed by annotating 51 more RCTs. %TODO - Elaborate
