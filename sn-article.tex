...
\subsection{LLM evaluation}
%
In the Table~\ref{table:LLM_eval}, we report the observed/raw agreement between LLMs in extracting and responding to the SQs over a subset (n=10 labelled RCTs) of RoBuster~\ref{method:llm}.
...
Which questions and judgments were subjective to make %TODO: Describe it here.
%
%
%
