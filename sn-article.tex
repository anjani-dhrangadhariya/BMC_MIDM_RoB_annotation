...
Expert annotators employed these visual guidelines to annotate a corpus of 40 full-text RCTs from physiotherapy and rehabilitation.
We report inter-annotator agreement (IAA) among two expert annotators when applying the guidelines to a portion (9 of 40) of the annotated corpus.
A portion of the corpus (10 out of 40) was used to evaluate ChatGPT using a straightforward evaluation framework.
% 
\textbf{Results:} We present a corpus of 40 RCTs with fine-grained span annotations comprising more than 11,500 tokens belonging to 22 RoB classes.
...
%These 40 studies were selected from four journals: journal 1, journal 2, journal 3 and journal 4. 
...
%A total of 40 full-text RCTs were annotated using this approach, covering 22 signaling questions across five risk domains defined by RoB 2.
%Out of the 40, nine were doubly-annotated to capture IAA and the rest were singly annotated.
...
The conflict resolution was followed by annotating 31 additional RCTs.
...
%TODO: How did the annotators perceive the difficulty of each signalling question? -> Make a scale
%
%
%
\subsection{Inter-Annotator Agreement}
...
\textbf{Polarity conflict} was when the annotators marked same part of text to answer the same question, but labelled them with polar opposite judgment option.
...
%ChatPDF can not yet read images in the PDF, including images that consist of scanned text.
