...
They conclude that the assessment guidelines cannot be used as text annotation guidelines, but neither provide any annotation guidelines from their end.
...
Each PDF was renamed with the primary outcome that was to be examined using RoB 2 before uploading to the annotation software.
...
Specifically, we considered evaluating risk domain two for effect of assignment to the intervention and not for the effect of adherence.
...
Out of the 60 documents, 9 were doubly annotated by two experienced annotators (E1MA and E2IRAA) to calculate inter-annotator agreement (IAA) over these documents and the rest were singly annotated by E1MA.
...
After the annotation of 9 doubly-annotated RCTs, we had to stop using tagtog and switched to the PAWLS~\footnote{\url{https://pawls.apps.allenai.org/}} annotation tool, which allows users to annotate PDFs for free~\cite{neumann2021pawls}.
