...
It tasks ChatPDF with two 1) answering the signalling question, and 2) extract the text evidence to support your answer.
...
\label{subsec:corpus}
%
In this section, we provide primary statistical information about the annotations we obtained for each risk domain and its corresponding signaling questions.
...
\begin{table}[htb]
    ...
    \begin{tabular}{ll}
    \hline
        Signalling question & Simple prompts (Accuracy) \\
    \hline
        RoB 1\_1 &   \\ 
        RoB 1\_2 &   \\ 
        RoB 1\_3 &   \\ 
