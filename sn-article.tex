...
Understanding the tool structure is essential to understanding the further sections of the paper.
...
%TODO - Give examples of good methods of randomization and bad methods of randomization.
For instance, let's consider signaling question 1.1 from risk domain 1 (randomization bias), which assesses whether the allocation sequence was randomly generated. 
To answer this question, reviewers must carefully examine the entire RCT to find the procedure describing the randomization process.
...
\begin{table*}
 \centering
    ...
    \hline
    \end{tabular}
  \caption{The table lists down the bias domains as structured in the revised Cochrane RoB assessment tool (RoB 2.0) and the number of signalling questions in each domain.}\label{tab1}
\end{table*}
%
%
%
